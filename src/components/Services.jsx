...
export default function ServicesSection() {
  ...
  const SERVICES = [
    ...
    {
      id: "cloud-architecture",
      title: t('services.cloudArchitecture'),
      description: t('services.cloudArchitectureDesc'),
      icon: CloudIcon,
      color: "#ec4899",
    },
    {
    ...
    {
      id: "blockchain-tech",
      title: t('services.blockchainTech'),
      description: t('services.blockchainTechDesc'),
      icon: CurrencyBitcoinIcon,
      color: "#8b5cf6",
    },
    {
      id: "mobile-innovation",
      title: t('services.mobileInnovation'),
      description: t('services.mobileInnovationDesc'),
      icon: SmartphoneIcon,
      color: "#f59e0b",
    },
    {
    ...
    {
      id: "data-intelligence",
      title: t('services.dataIntelligence'),
      description: t('services.dataIntelligenceDesc'),
      icon: BusinessIcon,
      color: "#06b6d4",
    },
    {
      ...
      description: t('services.techConsultingDesc'),
      icon: SupportAgentIcon,
      color: "#f97316",
    },
  ];
